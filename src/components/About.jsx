            ...
            {type === 0 && (
              <>
                <div className="flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center text-black/60">
                  <div className="font-light mb-2 md:mb-0 items">
                    ⚈ Web Development
                  </div>
            ...
            {type === 2 && (
              <>
                <div className="flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center text-black/60">
                  <div>
                    <div className="font-light mb-2 md:mb-0">
                      🎖️ Generative AI Fundamentals by Google
                    </div>
                  </div>
                </div>
                <div className="flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center text-black/60">
                  <div className="font-light mb-2 md:mb-0">
                    🎖️ AWS Beginner certification
                  </div>
                </div>
                <div className="flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center text-black/60">
                  <div className="font-light mb-2 md:mb-0">
                    🎖️ Externship on Data science by IBM
                  </div>
                </div>
                <div className="flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center text-black/60">
                  <div className="font-light mb-2 md:mb-0">
                    🎖️ DeVops Fundamentals by IBM
                  </div>
                </div>
                <div className="flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center text-black/60">
                  <div className="font-light mb-2 md:mb-0">
                    🎖️ Agile Training Module by IBM
                  </div>
                </div>
                <div className="flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center text-black/60">
                  <div className="font-light mb-2 md:mb-0">
                    🎖️ Design Thinking by IBM
                  </div>
                </div>
                <div className="flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center text-black/60">
                  <div className="font-light mb-2 md:mb-0">
                    🎖️ Google Cloud Skill Boost Badges on AI Principles,
