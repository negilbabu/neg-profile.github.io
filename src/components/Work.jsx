...
// const invStart = new Date("2022-10-01"); // Start date changed to October 1, 2022
// const currentDate = new Date();
// const monthsDiff =
//   (currentDate.getFullYear() - invStart.getFullYear()) * 12 +
//   (currentDate.getMonth() - invStart.getMonth());

// const data = [
//   {
//     year: `October 2022 to Present`,
...
const monthsDiff =
  (currentDate.getFullYear() - invStart.getFullYear()) * 12 +
  (currentDate.getMonth() - invStart.getMonth()) +
  1; // Adding 1 to include the starting month
