...
const Footer = () => {
  return (
    <>
      <div className="flex flex-col mx-3 bg-white rounded-lg pt-20">
            ...
            <div className="flex flex-col items-center w-full my-20">
              <div className="flex flex-col items-center gap-6 mb-8">
                ...
                <div className="flex items-center gap-8">
                  <a
                    href="https://www.facebook.com/negil.babu/"
                  ...
                  <a
                    href="https://twitter.com/Negil_Babu"
                    className="text-grey-700 hover:text-grey-900"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <a
                    href="https://www.linkedin.com/in/negil-babu/"
                    className="text-grey-700 hover:text-grey-900"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <a
                    href="https://www.instagram.com/mr_intravelor/"
                    className="text-grey-700 hover:text-grey-900"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
